...
const MovieDetails = () => {
  ...
  return (
    <View className='bg-primary flex-1'>
      <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
        ...
        <View className='flex-col items-start justify-center mt-5 px-5'> 
          ...
          <View className='flex flex-row justify-between w-1/2'>
            ...
            <MovieInfo label="Revenue" value={`$${(Math.round(movie?.revenue ?? 0) / 1_000_000).toFixed(2)}M` || 'N/A'} />
          </View>
      ...
      <TouchableOpacity className='absolute bottom-5 left-0 right-0 mx-5 bg-accent rounded-lg py-3.5 flex flex-row justify-center z-50' onPress={router.back}>
